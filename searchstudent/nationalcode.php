        ...
        <div class="px-3 pt-2">
            <main class="form-signin m-auto text-center w-50 p-3 rounded-3 bg-white mt-5">
                <form method="post" novalidate="">
                    <h2 class="h2 mb-3 fw-normal mb-4 mt-2">Search By Birth National Code</h2>
                    ...
                    <div class="form-floating mx-4 mb-3">
                        ...
                        <label for="nationalcode">Birth National Code</label>
                    </div>
            ...
            <div class="col-md-6">
                <div class="row g-0 bg-white border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <span href="#" class="stretched-link"><span class="fw-bold">Birth National Code:</span> <?php echo $info[5] ?></span>
