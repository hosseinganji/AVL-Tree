        ...
        <div class="px-3 pt-2">
            <main class="form-signin m-auto text-center w-50 p-3 rounded-3 bg-white mt-5">
                <form method="post" novalidate="">
                    <h2 class="h2 mb-3 fw-normal mb-4 mt-2">Search By Birth Certificate Number</h2>
...
<?php
    ...
    function search($root){  
        ...
        search($root->left);
        $GLOBALS["i"]++;
        $GLOBALS["searchbirthcertificatenumber"][$GLOBALS["i"]] = $root->value;
        search($root->right);
    }
    search($node);
...
<?php require("../head.php");  ?>
    ...
    <main class="container mt-4">
        <h1 class="fw-bold">Filter By: <?php echo $data["birthcertificatenumber"]?></h1>
<div class="row mb-2 mt-3">

<?php
//
    foreach($searchbirthcertificatenumber as $info){
        if($data["birthcertificatenumber"] == $info[5]){
            // var_dump($info);
        ?>
            <div class="col-md-6">
